...
AddEventHandler('esx_ambulancejob:removeItem', function(item)
	...
	elseif item == 'neckbrace' then
		xPlayer.showNotification(_U('used_neckbrace'))
	elseif item == 'legbrace' then
		xPlayer.showNotification(_U('used_legbrace'))
	elseif item == 'armbrace' then
		xPlayer.showNotification(_U('used_armbrace'))
	elseif item == 'bodybandage' then
		xPlayer.showNotification(_U('used_bodybandage'))
	end
end)
...
AddEventHandler('esx_ambulancejob:giveItem', function(itemName, amount)
	...
	elseif (itemName ~= 'medikit' and itemName ~= 'bandage') then
		print(('esx_ambulancejob: %s attempted to spawn in an item!'):format(xPlayer.identifier))
	elseif (itemName ~= 'neckbrace' and itemName ~= 'neckbrace') then
		print(('esx_ambulancejob: %s attempted to spawn in an item!'):format(xPlayer.identifier))
	elseif (itemName ~= 'legbrace' and itemName ~= 'legbrace') then
		print(('esx_ambulancejob: %s attempted to spawn in an item!'):format(xPlayer.identifier))
	elseif (itemName ~= 'armbrace' and itemName ~= 'armbrace') then
		print(('esx_ambulancejob: %s attempted to spawn in an item!'):format(xPlayer.identifier))
	elseif (itemName ~= 'bodybandage' and itemName ~= 'bodybandage') then
		print(('esx_ambulancejob: %s attempted to spawn in an item!'):format(xPlayer.identifier))
		return
	end
