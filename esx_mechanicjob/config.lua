...
--harvest menu--------------- 
	Garage = {
		Pos   = { x = 953.63, y = -954.17, z = 39.75 },
		Size  = { x = 0.7, y = 1.0, z = 0.8 },
		Color = { r = 255, g = 0, b = 0 },
		Type  = 2
	},
--harvest menu---------------
	Craft = {
		Pos   = { x = 951.61, y = -954.47, z = 39.75 },
		Size  = { x = 0.7, y = 1.0, z = 0.8 },
		Color = { r = 0, g = 0, b = 255 },
		Type  = 2
	},
	...
	VehicleSpawnPoint = {
		Pos   = { x = 916.76, y = -962.43, z = 39.58 },
		Size  = { x = 1.5, y = 1.5, z = 1.0 },
		Type  = -1
	},

	VehicleDeleter = {
		Pos   = { x = 912.85, y = -952.73, z = 39.75 },
